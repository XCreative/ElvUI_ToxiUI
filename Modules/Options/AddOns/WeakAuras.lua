...
function O:AddOns_WeakAuras()

    -- Create Tab
    self.options.addons.args["weakAurasGroup"] = {
        order = self:GetOrder(),
        type = "group",
        name = "WeakAuras",
        get = function(info)
    ...
    -- Options
    local options = self.options.addons.args["weakAurasGroup"]["args"]
    ...
    do
        ...
        local weakAurasIconsGroup = self:AddInlineRequirementsDesc(options, {
            ...
            name = "Makes the icons cropped, adds a border and also forces " .. F.StringElvUI("ElvUI") ..
                " Cooldowns.\n\n"
        ...
        weakAurasIconsGroup["args"]["enabled"] = {
            ...
            desc = "Toggling this on changes the shape of your WeakAuras Icons and also adds borders. It also forces " ..
                F.StringElvUI("ElvUI") .. " to skin the Cooldown Text."
        }

        -- Disabled helper
        local optionsDisabled = function()
            return self:GetEnabledState(E.db.TXUI.addons.weakAurasIcons.enabled, weakAurasIconsGroup) ~=
        ...
        weakAurasIconsGroup["args"]["iconShape"] = {
            ...
            values = { [I.Enum.IconShape.SQUARE] = "Square", [I.Enum.IconShape.RECTANGLE] = "Rectangle" },
    ...
    do
        ...
        local weakAurasBarsGroup = self:AddInlineRequirementsDesc(options, { name = "Bar Borders" }, {
...
O:AddCallback("AddOns_WeakAuras")
