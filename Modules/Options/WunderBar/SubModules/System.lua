...
function O:WunderBar_SubModules_System()
    ...
    local colorsDisabled = function()
        return not ((E.db.TXUI.wunderbar.subModules["System"].textColor) or
                   (E.db.TXUI.wunderbar.subModules["System"].showIcons and
                       E.db.TXUI.wunderbar.subModules["System"].iconColor))
    end
    ...
    tab.generalGroup.args.iconFontSize = ACH:Range("Icon Size", nil, 4, { min = 1, max = 100, step = 1 }, nil, nil, nil,
                                                   iconsDisabled)
    ...
    tab.colorGroup.args.textColorFadeFromNormal = ACH:Toggle("Text Color as Base", nil, 3, nil, nil, nil, nil, nil,
                                                             colorsDisabled)
    ...
    tab.colorGroup.args.textColorFramerateThreshold = ACH:Range("Framerate Threshold", nil, 5,
                                                                { min = 1, max = 1000, step = 1 }, nil, nil, nil,
                                                                colorsDisabled)
