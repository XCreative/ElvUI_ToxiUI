...
function O:WunderBar_SubModules_MicroMenu()
    ...
    tab.generalGroup.args.iconFontSize = ACH:Range("Icon Size", nil, 1, { min = 1, max = 100, step = 1 })
    tab.generalGroup.args.iconSpacing = ACH:Range("Spacing", nil, 2, { min = 1, max = 100, step = 1 })
    ...
    tab.generalGroup.args.newbieToolips = ACH:Toggle("Newbie Tooltips", nil, 5, nil, nil, nil, nil, nil,
                                                     tooltipsDisabled)
    ...
    tab.infoGroup.args.onlyFriendsWoW =
        ACH:Toggle("Only WoW Friends", nil, 3, nil, nil, nil, nil, nil, infoTextDisabled)
    ...
    tab.infoGroup.args.onlyFriendsWoWRetail = ACH:Toggle("Only Retail WoW", nil, 4, nil, nil, nil, nil, nil,
                                                         onlyFriendsWoWDisabled)
    ...
    tab.infoGroup.args.infoFontSize = ACH:Range("Font Size", nil, 7, { min = 1, max = 100, step = 1 }, nil, nil, nil,
                                                infoTextDisabled)

    tab.infoGroup.args.infoOffset = ACH:Range("Vertical Offset", nil, 8, { min = 1, max = 100, step = 1 }, nil, nil,
                                              nil, infoTextDisabled)
