...
function O:WunderBar_SubModules_DataBar()
    ...
    tab.barGroup.args.barHeight = ACH:Range("Bar Height", nil, 2, { min = 1, max = 20, step = 1 })
    tab.barGroup.args.barOffset = ACH:Range("Vertical Offset", nil, 3, { min = -10, max = 10, step = 1 })
    ...
    tab.infoGroup.args.infoFontSize = ACH:Range("Font Size", nil, 4, { min = 1, max = 100, step = 1 }, nil, nil, nil,
                                                infoTextDisabled)

    tab.infoGroup.args.infoOffset = ACH:Range("Vertical Offset", nil, 5, { min = 1, max = 100, step = 1 }, nil, nil,
