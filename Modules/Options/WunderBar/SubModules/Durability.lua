...
function O:WunderBar_SubModules_Durability()
    ...
    options.durability = ACH:Group("Durability", nil, self:GetOrder(), nil, function(info)
    ...
    tab.generalGroup.args.itemLevelShort = ACH:Toggle("Short Item Level", nil, 5, nil, nil, nil, nil, nil,
                                                      itemLevelDisabled)
    ...
    tab.animateGroup.args.animateThreshold = ACH:Range("Animate Threshold", nil, 2, { min = 1, max = 100, step = 1 })
