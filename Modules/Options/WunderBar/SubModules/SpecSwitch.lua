...
function O:WunderBar_SubModules_SpecSwitch()
    ...
    local infoTextDisabledDueToSpec = function()
        return (E.db.TXUI.wunderbar.subModules[dbEntry].general.showSpec1 and
                   E.db.TXUI.wunderbar.subModules[dbEntry].general.showSpec2)
    end
    ...
    tab.generalGroup.args.showSpec2 = ACH:Toggle("Show Loot Spec", nil, 7)
    ...
    tab.infoGroup.args.infoOffset = ACH:Range("Vertical Offset", nil, 7, { min = 1, max = 100, step = 1 }, nil, nil,
