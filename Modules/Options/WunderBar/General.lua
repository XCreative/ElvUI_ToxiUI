...
function O:WunderBar_General()
    ...
    do
        ...
        local wunderBarDesc = self:AddInlineRequirementsDesc(options, { name = "Description" }, {
        ...
        wunderBarDesc["args"]["enabled"] = {
            ...
            set = function(info, value)
                ...
                TXUI:GetModule("WunderBar"):ProfileUpdate()
            end
        }
    ...
    do
        -- General Group
        local generalGroup = self:AddInlineGroup(options, { name = "General", hidden = optionsHidden })
        ...
        generalGroup["args"]["barVisibility"] = {
            ...
            type = "select",
            name = "Visibility",
            values = { ALWAYS = "Always", NO_COMBAT = "Hide in Combat", RESTING = "Only in rested area" }
        }
    ...
    do
        -- Font Group
        local fontGroup = self:AddInlineGroup(options, { name = "Font", hidden = optionsHidden })
    ...
    do
        -- Color Group
        local colorGroup = self:AddInlineGroup(options, { name = "Color", hidden = optionsHidden })
    ...
    do
        -- Animation Group
        local animationsGroup = self:AddInlineGroup(options, { name = "Animation", hidden = optionsHidden })
    ...
    do
        -- Background Group
        local backgroundGroup = self:AddInlineGroup(options, { name = "Background", hidden = optionsHidden })

        backgroundGroup["args"]["backgroundTexture"] = ACH:SharedMediaStatusbar("Background Texture", nil,
                                                                                self:GetOrder())
